...
const VARIANT_CONTAINER_CLASS = {
  regular: "border-zinc-100 bg-zinc-50/50 dark:border-zinc-700 dark:bg-zinc-800/30",
  added: "border-emerald-200 bg-emerald-50/60 dark:border-emerald-800/60 dark:bg-emerald-950/30",
  deleted: "border-red-200 bg-red-50/60 dark:border-red-800/60 dark:bg-red-950/30",
